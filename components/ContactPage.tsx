...
import { MapPin, Phone, Mail, Apple, Play, ArrowRight, Check, Loader2, ArrowLeft } from 'lucide-react';
...
const ContactPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log("Submitting to harshs@damcogroup.com:", data);

    // Simulate enterprise API processing
    setTimeout(() => {
      setLoading(false);
      setSubmitted(true);
    }, 2000);
          ...
          <div className="lg:col-span-6 flex flex-col justify-start items-center lg:items-end">
            {!submitted ? (
              <div className="bg-white border border-gray-200 p-8 lg:p-12 shadow-sm relative overflow-hidden w-full max-w-lg">
                ...
                <p className="text-gray-500 font-medium mb-12">Connect with an enterprise solutions architect to discuss your revenue goals.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="pt-4">
                    ...
                    <button 
                      disabled={loading}
                      type="submit" 
                      className="w-full bg-koda-blue text-white py-6 px-10 font-bold text-xl flex items-center justify-between group hover:bg-koda-darkblue transition-all shadow-md active:scale-[0.98]"
                    >
                      {loading ? (
                        <>
              ...
              <div className="bg-white border border-gray-200 p-12 lg:p-16 text-center shadow-xl animate-fade-in-up w-full max-w-lg">
                ...
                <p className="text-gray-600 text-lg mb-12 leading-relaxed">
                  Thank you. An Enterprise Solutions Architect will contact you shortly to discuss your parking assets.
                </p>
                <div className="pt-8 border-t border-gray-100">
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Sent to</p>
                  <p className="text-lg font-bold text-koda-black mt-2">harshs@damcogroup.com</p>
                </div>
                <button 
